...
(function() {
  ...
  exports.run = function(args) {
    ...
    parser.on("-c --context <proxyContext>", "proxy context", function(context) {
      return option.context = context;
    });
    parser.on("-r --rewrite <pathRewrite>", "proxy pathRewrite", function(rewrite) {
      return option.rewrite = rewrite;
    });
