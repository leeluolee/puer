...
OptParser = (function(_super) {
  ...
  OptParser.prototype.options = function() {
    var callback, char, _i;
    char = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), callback = arguments[_i++];
  };

  OptParser.prototype.parse = function(argv) {};

  OptParser.prototype._action = function() {};
