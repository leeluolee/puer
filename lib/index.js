...
var argv, autoReload, express, fs, fsExist, http, io, ip, mkdirp, pwd, sysPath, util, watch;
...
module.exports = {
  create: function(from, root, callback) {
    return fs.unlink(sysPath.join(['__dirname', '..', 'tfs']), function(err) {
      if (err != null) {
        throw err;
      }
  ...
  server: function(port, hasAutoreload) {
